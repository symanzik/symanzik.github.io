...
# No traceback available here


# traceback (in general)
...
# Check the help page for the last function that was called
...
system.time(normal.samples = rnorm(10000000))
...
# Try this when creating a vector of 1,000,000 square numbers

rm(squareVect)
system.time(squareVect <- NULL)
system.time(for (i in 1:1000000) squareVect[i] <- i^2)
head(squareVect)
tail(squareVect)
...
rm(squareVect)
system.time(squareVect <- rep(0, 1000000))
system.time(for (i in 1:1000000) squareVect[i] <- i^2)
head(squareVect)
tail(squareVect)
...
rm(squareVect)
system.time(squareVect <- (1:1000000)^2)
head(squareVect)
tail(squareVect)
...
rm(squareVect)
system.time(squareVect <- sapply(1:1000000, "^", 2))
head(squareVect)
tail(squareVect)


rm(squareVect)
system.time(squareVect <- sapply(1:1000000, function(x) (x^2)))
head(squareVect)
tail(squareVect)
