# Stat 6910 - Homework 2 - Sat 1/26/2013
#
#
### Name:
#
...
# you also need to submit 3 pdf figures (see below for details).
#
...
load(url("http://www.math.usu.edu/~symanzik/teaching/2013_stat6910/LectureNotes/family.rda"))
...
load(url("http://www.math.usu.edu/~symanzik/teaching/2013_stat6910/LectureNotes/SFHousing.rda"))
...
### Do not forget to include this figure (and the two other pdf files with figures
### created earlier on) as part of your submission!
####
