...
#    http://www.math.usu.edu/~symanzik/teaching/2013_stat6910/LectureNotes/BRFSS_CDC.rda
...
load(url("http://www.math.usu.edu/~symanzik/teaching/2013_stat6910/LectureNotes/BRFSS_CDC.rda"))
