...
#
# Juergen Symanzik: Update on 9/4/2013

clockHTML <- readLines("http://www.census.gov/main/www/popclock.html")
...
clockHTML2 <- readLines("http://www.census.gov/main/www/popclock.html")
unlink("http://www.census.gov/main/www/popclock.html")
...
growthPerDay <- rateEstimate * 60 * 24
growthPerDay

cat("Currently, the world population grows at a rate of", growthPerDay,
    "people per day.\n")
