# L08c: Graphics 1 - Video Games

load(url("http://www.math.usu.edu/~symanzik/teaching/2013_stat6910_003_fall/Files/videogame.rda"))
...
# Note that I use c(5, 5, 5, 5) here instead of rep(5, 4).
# Most likely, I will further change some of these offsets,
# but not all of them. So, c(5, 5, 5, 5) only was a first guess.
