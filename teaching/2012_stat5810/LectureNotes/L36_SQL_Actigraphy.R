# L36: Read Actigraphy Data from SQL Data Base
#
...
connect <- dbConnect(driver, dbname = "C://JUE//Teaching//Stat5810_Fa2012_IntroStatComputing_XXX//LectureNotes//actread.db")
